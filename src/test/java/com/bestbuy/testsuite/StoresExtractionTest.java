...
public class StoresExtractionTest {
    ...
    public void test0014() {
        int total = response.extract().path("data[9].services.size");
    ...
    public void storeservice() {
        List<HashMap<String, ?>> services = response.extract().path("data.findAll{it.name=='Magnolia Home Theater'}.services.name");
