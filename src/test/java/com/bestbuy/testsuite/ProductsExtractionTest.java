...
public class ProductsExtractionTest {
    ...
    @Test
    public  void  extractthenamesofalltheproducts(){
    ...
    public void getCategoriesOfProductId150115() {
        List<Integer> categoriesSize = response.extract().path("data.findAll{it.name == '150115'}");
        int size = categoriesSize.size();
        System.out.println(size);
